...
import fx.com.idcard.api.ApiServer;
import fx.com.idcard.api.ApiUrl;
import fx.com.idcard.enumIndex.ActivateStatus;
import fx.com.idcard.enumIndex.ResultStatus;
import fx.com.idcard.interceptor.MyInterceptor;
import fx.com.idcard.mac.MacUtil;
...
public abstract class AbsPresenter implements BasePresenterInterface{
    ...
    public void createApiService() {
        OkHttpClient client = new OkHttpClient.Builder()
                ...
                .connectTimeout(8, TimeUnit.SECONDS)//连接超时秒数
                .build();
    ...
    protected Map<String,Object> getParameterMap(ActivateStatus activateStatus, ResultStatus resultStatus){
        return getParameterMap(activateStatus,resultStatus,null,null);
    }

    protected Map<String,Object> getParameterMap(ActivateStatus activateStatus,
